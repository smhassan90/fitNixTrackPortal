...
export default function PaymentReceiptWhatsAppButton({
  kind,
  id,
  memberId,
  fallbackPhone,
  ...
  return (
    <button
      ...
      className={
        className ||
        'inline-flex items-center gap-1.5 rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-1.5 text-sm font-medium text-emerald-800 hover:bg-emerald-100 disabled:opacity-50'
      }
    >
